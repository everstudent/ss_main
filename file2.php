...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="jquery.jqGauges.css" />-->
    <script src="jquery-1.11.1.min.js" type="text/javascript"></script>
    <script src="jquery.jqGauges.min.js" type="text/javascript"></script>
    ...
    <script lang="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $('#button').click(function () {
                $('#jqSegmentedDisplay').jqSegmentedDisplay('exportToPdf');
            });
        });
    </script>
...
<body>
    <div>
        ...
        <br />
        <input id="button" type="button" value="Export to Pdf" />
    </div>
</body>
</html>